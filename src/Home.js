        ...
        >
          ...
          <div className="flex gap-4">
            ...
            <div className="animated-text text-4xl md:text-7xl font-semibold">
              <div>
                <span className="animation block text-left relative after:content-[''] after:absolute after:left-0 after:-right-2 after:h-full after:bg-[#546f9c] after:border-l-2">
                  DEVELOPER
                </span>
                <span className="animation block text-left relative after:content-[''] after:absolute after:left-0 after:-right-2 after:h-full after:bg-[#546f9c] after:border-l-2">
                  DESIGNER
